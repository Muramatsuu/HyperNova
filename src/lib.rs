...
#[derive(Debug)]
pub struct HyperNovaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperNovaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperNova processing");
    
    let mut processor = HyperNovaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperNovaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperNovaProcessor::new(false);
